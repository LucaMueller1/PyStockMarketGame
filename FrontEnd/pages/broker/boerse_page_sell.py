...
def run(session_state):
    ...
    if mode_switch == "Verkaufen":
        ...
        if wkn_verkaufen_user_eingabe != " ":
            wkn_verkaufen_uebergabe = wkn_verkaufen_user_eingabe.split(": ")[1]
            ...
            if st.checkbox("Alle Aktien verkaufen", value=True):
                ...
                with col1:
                    ...
                    if input_methode == "Textfeld":
                        stock_quantity_raw = st.number_input("Oder gib die genaue Anzahl hier ein:", min_value = 1, step = 1)
                        stock_quantity = 1
            ...
            with col1:
                ...
                if st.button("Verkaufen"):
                    ...
                    # Talk to Backend
                    response = requests_server.post_transaction(session_state.auth_key, wkn_verkaufen_uebergabe,
